// gcc snowman_glfw.c -lglfw -lGL -lGLU -lm -o snowman_glfw && ./snowman_glfw
...
void drawGLScene(GLFWwindow* window)
{
	...
	// Main Body  
	gluSphere(pObj, 0.35f, 26, 13);  // Bottom
    ...
    glPushMatrix();
        glTranslatef(0.09f, 1.06f, 0.21f);
    ...
    glPushMatrix();
        ...
        gluCylinder(pObj, 0.18f, 0.16f, 0.3f, 26, 13);
    glPopMatrix();
	// Hat brim
    glPushMatrix();
        glTranslatef(0.0f, 1.16f, 0.0f);
        glRotatef(90.0f, -1.0f, 0.0f, 0.0f);
        gluCylinder(pObj, 0.35f, 0.35f, 0.04f, 26, 13);
    glPopMatrix();
    glPushMatrix();
        glTranslatef(0.0f, 1.5f, 0.0f);
        glRotatef(90.0f, -1.0f, 0.0f, 0.0f);
        gluDisk(pObj, 0.0f, 0.16f, 26, 13);
    glPopMatrix();
    // Buttons
    glColor3f(0.0f, 0.0f, 0.0f);
    glPushMatrix();
        glTranslatef(0.0f, 0.6f, 0.26f);
        gluSphere(pObj, 0.02f, 26, 13);
    glPopMatrix();
    glPushMatrix();
        glTranslatef(0.0f, 0.5f, 0.27f);
        gluSphere(pObj, 0.02f, 26, 13);
    glPopMatrix();
    // Arms
    ...
    glPushMatrix();
        ...
        glRotatef(90.0f, -20.0f, 80.0f, 0.0f);
        gluCylinder(pObj, 0.07f, 0.0f, 0.7f, 26, 13);
    glPopMatrix();
    glPushMatrix();
        glTranslatef(0.0f, 0.6f, 0.0f);
        glRotatef(-90.0f, 20.0f, 80.0f, 0.0f);
